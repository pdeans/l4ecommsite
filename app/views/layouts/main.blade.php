...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Sample eCommerce Site</title>
        ...
        <div id="wrapper">
            <header>
                ...
                <section id="action-bar">
                    ...
                    @if(Auth::check())
                        <nav class="dropdown">
                            <ul>
                                <li>
                                    <a href="#">
                                        {{ HTML::image('img/user-icon.gif', Auth::user()->firstname) }} {{ Auth::user()->firstname}} {{ HTML::image('img/down-arrow.gif', Auth::user()->firstname) }}
                                    </a>
                                    <ul>
                    ...
                    <div id="view-cart">
                        <a href="{{ URL::to('store/cart') }}">{{ HTML::image('img/blue-cart.gif', 'View Cart') }} View Cart</a>
                    </div><!-- end view-cart -->
            ...
            <footer>
                ...
                <section id="bottom" class="clearfix">
                    <div id="copyright">
                        ...
                        <p id="store-copy">&copy; 2014 Sample eCommerce Site.</p>
                    </div><!-- end copyright -->
                    <div id="connect">
